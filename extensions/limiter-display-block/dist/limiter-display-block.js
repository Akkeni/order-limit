(() => {
  ...
  // extensions/limiter-display-block/src/BlockExtension.jsx
  var import_react17 = __toESM(require_react());

  // extensions/limiter-display-block/src/utils.js
  function updateLimiters(productId, limiters) {
    return __async(this, null, function* () {
      var _a, _b;
      ...
      const metaData = yield makeGraphQLQuery(
      ...
      const categoryData = yield makeGraphQLQuery(
        `mutation SetMetafield($namespace: String!, $ownerId: ID!, $key: String!, $type: String!, $value: String!) {
        metafieldDefinitionCreate(
          definition: {namespace: $namespace, key: $key, name: "Tracked Issues", ownerType: PRODUCT, type: $type, access: {admin: MERCHANT_READ_WRITE}}
        ) {
  ...
  function createVendorWiseLimiter(allProductsData, limiter) {
    return __async(this, null, function* () {
      var _a;
      ...
      try {
        ...
        product(id: $id) {
          ...
          yield handleGraphqlMutation(id, value);
        }
      } catch (error) {
  ...
  function createCategoryWiseLimiter(allProductsData, limiter) {
    return __async(this, null, function* () {
      const productIds = allProductsData.filter((product) => {
        var _a;
        return ((_a = product.node.category) == null ? void 0 : _a.name) === limiter.id;
      }).map((product) => product.node.id);
      try {
        for (const id of productIds) {
          let value = `${limiter.id},${limiter.value}`;
          yield handleGraphqlCategoryMutation(id, value);
        }
      } catch (error) {
  ...
  function handleGraphqlCategoryMutation(productId, categoryValue) {
    return __async(this, null, function* () {
      const categoryData = yield makeGraphQLQuery(
        `mutation SetMetafield($namespace: String!, $ownerId: ID!, $key: String!, $type: String!, $value: String!) {
        metafieldDefinitionCreate(
  ...
  function handleGraphqlMutation(productId, productValue) {
    return __async(this, null, function* () {
      const vendorData = yield makeGraphQLQuery(
        `mutation SetMetafield($namespace: String!, $ownerId: ID!, $key: String!, $type: String!, $value: String!) {
        metafieldDefinitionCreate(
          definition: {namespace: $namespace, key: $key, name: "Tracked Issues", ownerType: PRODUCT, type: $type, access: {admin: MERCHANT_READ_WRITE}}
        ) {
  ...
  function getLimiters(productId) {
    return __async(this, null, function* () {
  ...
  function getPlan() {
    return __async(this, null, function* () {
      ...
      const planDetails = yield makeGraphQLQuery(`query appInstallation {
      ...
      if (((_c = (_b = (_a = planDetails == null ? void 0 : planDetails.data) == null ? void 0 : _a.currentAppInstallation) == null ? void 0 : _b.planMetaField) == null ? void 0 : _c.value) == "true") {
        ...
        if ((_f = (_e = (_d = planDetails == null ? void 0 : planDetails.data) == null ? void 0 : _d.currentAppInstallation) == null ? void 0 : _e.freePlanLimitersMetaField) == null ? void 0 : _f.value) {
          allPlanDetails.freePlanLimiters = JSON.parse((_i = (_h = (_g = planDetails == null ? void 0 : planDetails.data) == null ? void 0 : _g.currentAppInstallation) == null ? void 0 : _h.freePlanLimitersMetaField) == null ? void 0 : _i.value);
          return allPlanDetails;
        }
      }
      return allPlanDetails;
  ...
  function App() {
    ...
    (0, import_react17.useEffect)(() => {
      (function getProductInfo() {
        return __async(this, null, function* () {
          ...
          const productData = yield getLimiters(productId);
          const allPlanDetails = yield getPlan();
          const existingLimiters = allPlanDetails.freePlanLimiters;
          if (allPlanDetails.plan === false) {
            freePlanLimiters.products = ((_a = existingLimiters.find((item) => item.typeName == "products")) == null ? void 0 : _a.value) || 0;
            freePlanLimiters.categories = ((_b = existingLimiters.find((item) => item.typeName == "categories")) == null ? void 0 : _b.value) || 0;
            freePlanLimiters.collections = ((_c = existingLimiters.find((item) => item.typeName == "collections")) == null ? void 0 : _c.value) || 0;
            freePlanLimiters.vendors = ((_d = existingLimiters.find((item) => item.typeName == "vendors")) == null ? void 0 : _d.value) || 0;
          }
          ...
          if ((_g = (_f = (_e = productData == null ? void 0 : productData.data) == null ? void 0 : _e.product) == null ? void 0 : _f.category) == null ? void 0 : _g.name) {
            setLimiters((prevState) => {
              var _a2, _b2, _c2;
              return __spreadProps(__spreadValues({}, prevState), {
                categoryName: (_c2 = (_b2 = (_a2 = productData == null ? void 0 : productData.data) == null ? void 0 : _a2.product) == null ? void 0 : _b2.category) == null ? void 0 : _c2.name
              });
            });
            if ((_j = (_i = (_h = productData == null ? void 0 : productData.data) == null ? void 0 : _h.product) == null ? void 0 : _i.categoryLimitField) == null ? void 0 : _j.value) {
              const [categoryName, categoryMin, categoryMax] = (_m = (_l = (_k = productData == null ? void 0 : productData.data) == null ? void 0 : _k.product) == null ? void 0 : _l.categoryLimitField) == null ? void 0 : _m.value.split(",");
              setLimiters((prevState) => __spreadProps(__spreadValues({}, prevState), {
          ...
          if ((_o = (_n = productData == null ? void 0 : productData.data) == null ? void 0 : _n.product) == null ? void 0 : _o.vendor) {
            setLimiters((prevState) => {
              var _a2, _b2;
              return __spreadProps(__spreadValues({}, prevState), {
                vendorName: (_b2 = (_a2 = productData == null ? void 0 : productData.data) == null ? void 0 : _a2.product) == null ? void 0 : _b2.vendor
              });
            });
            if ((_r = (_q = (_p = productData == null ? void 0 : productData.data) == null ? void 0 : _p.product) == null ? void 0 : _q.metafield) == null ? void 0 : _r.value) {
              const [productMin, productMax, vendorName, vendorMin, vendorMax] = (_u = (_t = (_s = productData == null ? void 0 : productData.data) == null ? void 0 : _s.product) == null ? void 0 : _t.metafield) == null ? void 0 : _u.value.split(",");
              if (isNaN(vendorName)) {
                setLimiters((prevState) => __spreadProps(__spreadValues({}, prevState), {
                  ["vendorMin"]: vendorMin,
                  ["vendorMax"]: vendorMax
          ...
          if ((_x = (_w = (_v = productData == null ? void 0 : productData.data) == null ? void 0 : _v.product) == null ? void 0 : _w.metafield) == null ? void 0 : _x.value) {
            const [productMin, productMax, vendorName, vendorMin, vendorMax] = (_A = (_z = (_y = productData == null ? void 0 : productData.data) == null ? void 0 : _y.product) == null ? void 0 : _z.metafield) == null ? void 0 : _A.value.split(",");
            setLimiters((prevState) => __spreadProps(__spreadValues({}, prevState), {
    ...
    const handleSave = () => __async(this, null, function* () {
      setLoading(true);
      const result = yield updateLimiters(productId, limiters);
    ...
    return (
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(AdminBlock2, { title: "Order Limit app limiters", children: [
        loading && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { children: "Loading..." }),
        !loading && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { gap: true, children: [
          isAllow.product ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Box2, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(InlineStack2, { gap: true, children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
              NumberField2,
              {
                value: limiters == null ? void 0 : limiters.productMin,
                label: "Product Min Limit",
                type: "number",
                onChange: (value) => {
                  handleLimiters(value, "productMin");
                }
              }
            ),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
              NumberField2,
              {
                value: limiters == null ? void 0 : limiters.productMax,
          ...
          ] }) }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { children: "You used allowed product wise limits. To continue please select a plan or set existing limits to 0." }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Divider2, {}),
          isAllow.vendor ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Box2, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { blockGap: "small", children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Heading2, { size: "6", children: [
              "Vendor Name: ",
              limiters == null ? void 0 : limiters.vendorName
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(InlineStack2, { gap: true, children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                NumberField2,
                {
                  value: limiters == null ? void 0 : limiters.vendorMin,
                  label: "vendor Min Limit",
                  type: "number",
                  onChange: (value) => {
                    handleLimiters(value, "vendorMin");
                  }
                }
              ),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                NumberField2,
                {
                  value: limiters == null ? void 0 : limiters.vendorMax,
          ...
          ] }) }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { children: "You used allowed vendor wise limits. To continue please select a plan or set existing limits to 0." }),
          isAllow.category ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_jsx_runtime4.Fragment, { children: (limiters == null ? void 0 : limiters.categoryName) && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Divider2, {}),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Box2, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { blockGap: "small", children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Heading2, { size: "6", children: [
                "Category Name: ",
                limiters == null ? void 0 : limiters.categoryName
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(InlineStack2, { gap: true, children: [
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                  NumberField2,
                  {
                    ...
                    type: "number",
                    onChange: (value) => {
                      handleLimiters(value, "categoryMin");
                    }
                  }
                ),
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            ...
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Divider2, {}),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { children: "You used allowed category wise limits. To continue please select a plan or set existing limits to 0." })
          ] }),
...
//# sourceMappingURL=limiter-display-block.js.map
