...
${errorInfo.componentStack}`);
  ...
  function Extension() {
    ...
    console.log("currencyCode in extension " + cartCurrencyCode + " , " + (generalLimiters == null ? void 0 : generalLimiters.currencyCode));
    ...
    console.log(convertWeight(1e3, "grams", "kilograms"));
    for (const cartLine of cartLines) {
      ...
      `).then(({ data }) => {
        ...
        if (variant) {
          ...
          const toWeightUnit = generalLimiters == null ? void 0 : generalLimiters.weightUnit;
    ...
    useBuyerJourneyIntercept(({ canBlockProgress: canBlockProgress2 }) => {
      if ((errorMsgs == null ? void 0 : errorMsgs.extensionMsg) === "Checkout Extension" || (errorMsgs == null ? void 0 : errorMsgs.extensionMsg) === "Both") {
        if (cartCurrencyCode != (generalLimiters == null ? void 0 : generalLimiters.currencyCode) && (errorMsgs == null ? void 0 : errorMsgs.plan) === true) {
          return {
            behavior: "block",
          ...
          if (canBlockProgress2 && totalAmountValue < Number(generalLimiters == null ? void 0 : generalLimiters.priceMin)) {
            return {
              behavior: "block",
              ...
              errors: [
                {
                  // Show a validation error on the page
                  message: (errorMsgs == null ? void 0 : errorMsgs.priceMinErrMsg) ? errorMsgs.priceMinErrMsg.replace("{priceMin}", generalLimiters == null ? void 0 : generalLimiters.priceMin) : `Minimum amount ${generalLimiters == null ? void 0 : generalLimiters.priceMin} is required for checkout`
                }
              ]
            };
          }
        }
        if (canBlockProgress2 && totalQuantity < storeMin) {
          return {
            behavior: "block",
            ...
            errors: [
              {
                // Show a validation error on the page
                message: (errorMsgs == null ? void 0 : errorMsgs.shopMinErrMsg) ? errorMsgs.shopMinErrMsg.replace("{shopMin}", storeMin) : `Minmum ${storeMin} products are required for checkout`
              }
            ]
          };
        }
        if (canBlockProgress2 && totalWeight < Number(generalLimiters == null ? void 0 : generalLimiters.weightMin)) {
          return {
            ...
            errors: [
              {
                // Show a validation error on the page
                message: (errorMsgs == null ? void 0 : errorMsgs.weightMinErrMsg) ? errorMsgs.weightMinErrMsg.replace("{weightMin}", generalLimiters == null ? void 0 : generalLimiters.weightMin).replace("{weightUnit}", generalLimiters == null ? void 0 : generalLimiters.weightUnit.toLowerCase()) : `Minmum weight ${generalLimiters == null ? void 0 : generalLimiters.weightMin} ${generalLimiters == null ? void 0 : generalLimiters.weightUnit.toLowerCase()} is required for checkout`
              }
            ]
          };
        }
