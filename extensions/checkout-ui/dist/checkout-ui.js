...
${errorInfo.componentStack}`);
  ...
  function Extension() {
    ...
    useBuyerJourneyIntercept(({ canBlockProgress: canBlockProgress2 }) => {
      if ((errorMsgs == null ? void 0 : errorMsgs.extensionMsg) === "Checkout Extension") {
  ...
  function App() {
    ...
    (0, import_react15.useEffect)(() => {
      ...
      if (productMetafield || productVariantMetafield) {
        ...
        if (quantity < productMin && productMin !== 0) {
          let msg = (errorMsgs == null ? void 0 : errorMsgs.productMinErrMsg) ? errorMsgs.productMinErrMsg.replace("{productMin}", productMin) : `You can't select less than ${productMin} for this product.`;
          setErrorMessage(msg);
        } else if (quantity < productVariantMin && productVariantMin !== 0) {
          let msg = (errorMsgs == null ? void 0 : errorMsgs.variantMinErrMsg) ? errorMsgs.variantMinErrMsg.replace("{productVariantMin}", productVariantMin) : `You can't select less than ${productVariantMin} for this product variant.`;
          setErrorMessage(msg);
        }
      }
    ...
    if (errorMessage && canBlockProgress && (errorMsgs == null ? void 0 : errorMsgs.extensionMsg) === "Checkout Extension") {
