...
${errorInfo.componentStack}`);
  ...
  function Extension() {
    ...
    for (const cartLine of cartLines) {
      const productId = (_f = (_e = cartLine == null ? void 0 : cartLine.merchandise) == null ? void 0 : _e.product) == null ? void 0 : _f.id;
      const productVariantId = (_g = cartLine == null ? void 0 : cartLine.merchandise) == null ? void 0 : _g.id;
      query(`
      {
    ...
    for (const name in collectionsWithProducts) {
      ...
      for (const id of collectionsWithProducts[name]) {
        const quantity = (_i = cartLines.find((item) => {
          var _a2, _b2;
          return ((_b2 = (_a2 = item == null ? void 0 : item.merchandise) == null ? void 0 : _a2.product) == null ? void 0 : _b2.id) === `gid://shopify/Product/${id}`;
        })) == null ? void 0 : _i.quantity;
        if (quantity) {
          c += quantity;
        }
      }
    ...
    if (vendorsWithProducts) {
      for (const name in vendorsWithProducts) {
        ...
        for (const id of vendorsWithProducts[name]) {
          const quantity = (_j = cartLines.find((item) => {
            var _a2, _b2;
            return ((_b2 = (_a2 = item == null ? void 0 : item.merchandise) == null ? void 0 : _a2.product) == null ? void 0 : _b2.id) === `gid://shopify/Product/${id}`;
          })) == null ? void 0 : _j.quantity;
          if (quantity) {
            c += quantity;
          }
        }
    ...
    useBuyerJourneyIntercept(({ canBlockProgress: canBlockProgress2 }) => {
      if ((errorMsgs == null ? void 0 : errorMsgs.extensionMsg) === "Checkout Extension" || (errorMsgs == null ? void 0 : errorMsgs.extensionMsg) === "Both") {
        if (canBlockProgress2 && totalAmountValue < priceMin) {
          return {
            behavior: "block",
            ...
            errors: [
              {
                ...
                message: (errorMsgs == null ? void 0 : errorMsgs.priceMinErrMsg) ? errorMsgs.priceMinErrMsg.replace("{priceMin}", priceMin) : `Minimum amount ${priceMin} is required for checkout`
              }
            ]
          };
        }
        ...
        if (canBlockProgress2 && totalWeight < Number(weightMin)) {
          return {
            behavior: "block",
            ...
            errors: [
              {
                // Show a validation error on the page
                message: (errorMsgs == null ? void 0 : errorMsgs.weightMinErrMsg) ? errorMsgs.weightMinErrMsg.replace("{weightMin}", weightMin) : `Minmum weight ${weightMin} is required for checkout`
              }
            ]
          };
        }
