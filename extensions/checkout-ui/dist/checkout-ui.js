...
${errorInfo.componentStack}`);
  ...
  function Extension() {
    ...
    const priceMetaField = (_a = priceLimitField[0]) == null ? void 0 : _a.metafield;
    const priceMin = priceMetaField == null ? void 0 : priceMetaField.value.split(",")[0];
    const priceMax = priceMetaField == null ? void 0 : priceMetaField.value.split(",")[1];
    const storeMetaField = (_b = storeLimitField[0]) == null ? void 0 : _b.metafield;
    const storeMin = storeMetaField == null ? void 0 : storeMetaField.value.split(",")[0];
    const storeMax = storeMetaField == null ? void 0 : storeMetaField.value.split(",")[1];
    const weightMetaField = (_c = weightLimitField[0]) == null ? void 0 : _c.metafield;
    const weightMin = weightMetaField == null ? void 0 : weightMetaField.value.split(",")[0];
    const weightMax = weightMetaField == null ? void 0 : weightMetaField.value.split(",")[1];
    const errorMsgsMetaField = (_d = errorMsgsField[0]) == null ? void 0 : _d.metafield;
    let errorMsgs = {};
    if (errorMsgsMetaField == null ? void 0 : errorMsgsMetaField.value) {
      errorMsgs = JSON.parse(errorMsgsMetaField == null ? void 0 : errorMsgsMetaField.value);
    }
    const generalLimitersMetaField = (_e = generalLimitersField[0]) == null ? void 0 : _e.metafield;
    let generalLimiters = {};
    if (generalLimitersMetaField == null ? void 0 : generalLimitersMetaField.value) {
      generalLimiters = JSON.parse(generalLimitersMetaField == null ? void 0 : generalLimitersMetaField.value);
    }
    const [errorMessages, setErrorMessages] = (0, import_react14.useState)("");
    const canBlockProgress = useExtensionCapability("block_progress");
    const cartLines = useCartLines();
    const totalAmount = useTotalAmount();
    const totalAmountValue = Number(totalAmount == null ? void 0 : totalAmount.amount);
    const cartCurrencyCode = (_h = (_g = (_f = cartLines[0]) == null ? void 0 : _f.cost) == null ? void 0 : _g.totalAmount) == null ? void 0 : _h.currencyCode;
    ...
    for (const cartLine of cartLines) {
      const productId = (_j = (_i = cartLine == null ? void 0 : cartLine.merchandise) == null ? void 0 : _i.product) == null ? void 0 : _j.id;
      const productVariantId = (_k = cartLine == null ? void 0 : cartLine.merchandise) == null ? void 0 : _k.id;
      const quantity = cartLine == null ? void 0 : cartLine.quantity;
      query(`
      {
      ...
      `).then(({ data }) => {
        var _a2, _b2, _c2;
        const variant = (_b2 = (_a2 = data == null ? void 0 : data.product) == null ? void 0 : _a2.variants) == null ? void 0 : _b2.edges.find((variant2) => variant2.node.id === productVariantId);
        if (variant) {
          let cartWeight = Number(variant.node.weight);
          const fromWeightUnit = (_c2 = variant.node) == null ? void 0 : _c2.weightUnit;
    ...
    categoryLimitFields.forEach((item) => {
      ...
      const category = valueParts[0];
      const minValue = valueParts[1];
      const maxValue = valueParts[2];
      const productId = item.target.id;
    ...
    for (const name in categoriesWithProducts) {
      ...
      for (const id of categoriesWithProducts[name]) {
        const quantity = (_l = cartLines.find((item) => {
          var _a2, _b2;
          return ((_b2 = (_a2 = item == null ? void 0 : item.merchandise) == null ? void 0 : _a2.product) == null ? void 0 : _b2.id) === `gid://shopify/Product/${id}`;
        })) == null ? void 0 : _l.quantity;
        if (quantity) {
          c += quantity;
        }
      }
    ...
    Object.keys(categoriesWithMinValues).forEach((category) => {
      ...
      const totalQuantity2 = totalCategoriesQuantity[category] || 0;
      if (totalQuantity2 < minQuantity) {
        let msg = (errorMsgs == null ? void 0 : errorMsgs.categoryMinErrMsg) ? errorMsgs.categoryMinErrMsg.replace("{categoryMin}", minQuantity).replace("{categoryName}", category) : `You have to select minimun ${minQuantity} products from the category "${category}".`;
        categoryErrors.push(msg);
      } else if (totalQuantity2 > maxQuantity && maxQuantity != 0) {
        let msg = errorMsgs.categoryMaxErrMsg ? errorMsgs.categoryMaxErrMsg.replace("{categoryMax}", maxQuantity).replace("{categoryName}", category) : `Can't select more than ${maxQuantity} products from the category "${category}".`;
        categoryErrors.push(msg);
      }
    });
    ...
    for (const name in collectionsWithProducts) {
      ...
      for (const id of collectionsWithProducts[name]) {
        const quantity = (_m = cartLines.find((item) => {
          var _a2, _b2;
          return ((_b2 = (_a2 = item == null ? void 0 : item.merchandise) == null ? void 0 : _a2.product) == null ? void 0 : _b2.id) === `gid://shopify/Product/${id}`;
        })) == null ? void 0 : _m.quantity;
        if (quantity) {
          c += quantity;
        }
      }
    ...
    Object.keys(collectionsWithMinValues).forEach((collection) => {
      ...
      const totalQuantity2 = totalCollectionsQuantity[collection] || 0;
      if (totalQuantity2 < minQuantity) {
        let msg = (errorMsgs == null ? void 0 : errorMsgs.collectionMinErrMsg) ? errorMsgs.collectionMinErrMsg.replace("{collectionMin}", minQuantity).replace("{collectionName}", collection) : `You have to select minimun ${minQuantity} products from the collection "${collection}".`;
        collectionErrors.push(msg);
      } else if (totalQuantity2 > maxQuantity && maxQuantity != 0) {
        let msg = errorMsgs.collectionMaxErrMsg ? errorMsgs.collectionMaxErrMsg.replace("{collectionMax}", maxQuantity).replace("{collectionName}", collection) : `Can't select more than ${maxQuantity} products from the collection "${collection}".`;
        collectionErrors.push(msg);
      }
    });
    ...
    productLimitFields.forEach((item) => {
      ...
      if (isNaN(vendorName)) {
        ...
        const minValue = vendorMin;
        const maxValue = vendorMax;
        const productId = item.target.id;
    ...
    if (vendorsWithProducts) {
      for (const name in vendorsWithProducts) {
        ...
        for (const id of vendorsWithProducts[name]) {
          const quantity = (_n = cartLines.find((item) => {
            var _a2, _b2;
            return ((_b2 = (_a2 = item == null ? void 0 : item.merchandise) == null ? void 0 : _a2.product) == null ? void 0 : _b2.id) === `gid://shopify/Product/${id}`;
          })) == null ? void 0 : _n.quantity;
          if (quantity) {
            c += quantity;
          }
        }
    ...
    if (vendorsWithMinValues) {
      Object.keys(vendorsWithMinValues).forEach((vendor) => {
        ...
        const totalQuantity2 = totalVendorsQuantity[vendor] || 0;
        if (totalQuantity2 < minQuantity) {
          let msg = (errorMsgs == null ? void 0 : errorMsgs.vendorMinErrMsg) ? errorMsgs.vendorMinErrMsg.replace("{vendorMin}", minQuantity).replace("{vendorName}", vendor) : `You have to select minimun ${minQuantity} products from the vendor "${vendor}".`;
          vendorErrors.push(msg);
        } else if (totalQuantity2 > maxQuantity && maxQuantity != 0) {
          let msg = errorMsgs.vendorMaxErrMsg ? errorMsgs.vendorMaxErrMsg.replace("{vendorMax}", maxQuantity).replace("{vendorName}", vendor) : `Can't select more than ${maxQuantity} products from the vendor "${vendor}".`;
          vendorErrors.push(msg);
        }
      });
    ...
    useBuyerJourneyIntercept(({ canBlockProgress: canBlockProgress2 }) => {
      if ((errorMsgs == null ? void 0 : errorMsgs.extensionMsg) === "Checkout Extension" || (errorMsgs == null ? void 0 : errorMsgs.extensionMsg) === "Both") {
        if (canBlockProgress2 && totalQuantity < storeMin && storeMin > 0) {
          return {
            behavior: "block",
            reason: "Minimum products quantity required",
            errors: [
              {
                message: (errorMsgs == null ? void 0 : errorMsgs.shopMinErrMsg) ? errorMsgs.shopMinErrMsg.replace("{shopMin}", storeMin) : `Minimum ${storeMin} products are required for checkout`
              }
            ]
          };
        } else if (canBlockProgress2 && totalQuantity > storeMax && storeMax > 0) {
          return {
            behavior: "block",
            reason: "Maximum products quantity reached",
            errors: [
              {
                message: (errorMsgs == null ? void 0 : errorMsgs.shopMaxErrMsg) ? errorMsgs.shopMaxErrMsg.replace("{shopMax}", storeMax) : `Cart exceeds ${storeMax} products. Please remove some items`
              }
            ]
          };
        }
        if (cartCurrencyCode !== (generalLimiters == null ? void 0 : generalLimiters.currencyCode) && (errorMsgs == null ? void 0 : errorMsgs.plan)) {
          return {
            behavior: "block",
            reason: "Correct currency code is required",
            errors: [
              {
                message: `Please change your shopping currency to ${generalLimiters == null ? void 0 : generalLimiters.currencyCode} to proceed with checkout`
              }
            ]
          };
        } else {
          if (canBlockProgress2 && totalAmountValue < Number(generalLimiters == null ? void 0 : generalLimiters.priceMin) && Number(generalLimiters == null ? void 0 : generalLimiters.priceMin) > 0) {
            return {
              behavior: "block",
              reason: "Minimum price required",
              errors: [
                {
                  message: (errorMsgs == null ? void 0 : errorMsgs.priceMinErrMsg) ? errorMsgs.priceMinErrMsg.replace("{priceMin}", generalLimiters == null ? void 0 : generalLimiters.priceMin).replace("{currencyCode}", generalLimiters == null ? void 0 : generalLimiters.currencyCode) : `Minimum amount ${generalLimiters == null ? void 0 : generalLimiters.priceMin} ${generalLimiters == null ? void 0 : generalLimiters.currencyCode} is required for checkout.`
                }
              ]
            };
          } else if (canBlockProgress2 && totalAmountValue > Number(generalLimiters == null ? void 0 : generalLimiters.priceMax) && Number(generalLimiters == null ? void 0 : generalLimiters.priceMax) > 0) {
            return {
              behavior: "block",
              reason: "Maximum price reached",
              errors: [
                {
                  message: (errorMsgs == null ? void 0 : errorMsgs.priceMaxErrMsg) ? errorMsgs.priceMaxErrMsg.replace("{priceMax}", generalLimiters.priceMax).replace("{currencyCode}", generalLimiters == null ? void 0 : generalLimiters.currencyCode) : `Cart exceeds amount ${generalLimiters.priceMax} ${generalLimiters == null ? void 0 : generalLimiters.currencyCode}. Please remove some items.`
                }
              ]
            };
          }
        }
        if (canBlockProgress2 && totalWeight < Number(generalLimiters == null ? void 0 : generalLimiters.weightMin)) {
          return {
            behavior: "block",
            reason: "Minimum weight required",
            errors: [
              {
                message: (errorMsgs == null ? void 0 : errorMsgs.weightMinErrMsg) ? errorMsgs.weightMinErrMsg.replace("{weightMin}", generalLimiters == null ? void 0 : generalLimiters.weightMin).replace("{weightUnit}", generalLimiters == null ? void 0 : generalLimiters.weightUnit.toLowerCase()) : `Minimum weight ${generalLimiters == null ? void 0 : generalLimiters.weightMin} ${generalLimiters == null ? void 0 : generalLimiters.weightUnit.toLowerCase()} is required for checkout`
              }
            ]
          };
        } else if (canBlockProgress2 && totalWeight > Number(generalLimiters == null ? void 0 : generalLimiters.weightMax)) {
          return {
            behavior: "block",
            reason: "Maximum weight exceeded",
            errors: [
              {
                message: (errorMsgs == null ? void 0 : errorMsgs.weightMaxErrMsg) ? errorMsgs.weightMaxErrMsg.replace("{weightMax}", generalLimiters == null ? void 0 : generalLimiters.weightMax).replace("{weightUnit}", generalLimiters == null ? void 0 : generalLimiters.weightUnit.toLowerCase()) : `Cart exceeds weight ${generalLimiters == null ? void 0 : generalLimiters.weightMax} ${generalLimiters == null ? void 0 : generalLimiters.weightUnit.toLowerCase()}. Please remove some items`
              }
            ]
          };
        }
        if (canBlockProgress2 && vendorErrors) {
          return {
            behavior: "block",
            reason: "Vendor error",
            errors: [
        ...
        if (canBlockProgress2 && collectionErrors) {
          return {
            behavior: "block",
        ...
        if (canBlockProgress2 && categoryErrors) {
          return {
            behavior: "block",
  ...
  // extensions/checkout-ui/src/productMinCheck.jsx
  var import_react15 = __toESM(require_react());
  var import_jsx_runtime5 = __toESM(require_jsx_runtime());
  var productMinCheck_default = reactExtension("purchase.checkout.cart-line-item.render-after", () => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(App, {}));
  function App() {
    var _a;
    const translate = useTranslate();
    ...
    const canBlockProgress = useExtensionCapability("block_progress");
    const errorMsgsMetaField = (_a = errorMsgsField[0]) == null ? void 0 : _a.metafield;
    let errorMsgs = {};
    if (errorMsgsMetaField == null ? void 0 : errorMsgsMetaField.value) {
      errorMsgs = JSON.parse(errorMsgsMetaField == null ? void 0 : errorMsgsMetaField.value);
    }
    (0, import_react15.useEffect)(() => {
      ...
      const productId = (_b = (_a2 = cartLineTarget == null ? void 0 : cartLineTarget.merchandise) == null ? void 0 : _a2.product) == null ? void 0 : _b.id;
      if (!productId) {
        return;
      }
      const productVariantId = (_c = cartLineTarget == null ? void 0 : cartLineTarget.merchandise) == null ? void 0 : _c.id;
      if (!productVariantId) {
        return;
      }
      const quantity = cartLineTarget == null ? void 0 : cartLineTarget.quantity;
      ...
      if (productMetafield || productVariantMetafield) {
        const productMeta = productMetafield == null ? void 0 : productMetafield.metafield;
        const productMin = Number(productMeta == null ? void 0 : productMeta.value.split(",")[0]);
        const productMax = Number(productMeta == null ? void 0 : productMeta.value.split(",")[1]);
        const productVariantMeta = productVariantMetafield == null ? void 0 : productVariantMetafield.metafield;
        const productVariantMin = Number(productVariantMeta == null ? void 0 : productVariantMeta.value.split(",")[0]);
        const productVariantMax = Number(productVariantMeta == null ? void 0 : productVariantMeta.value.split(",")[1]);
        if (quantity < productMin && productMin !== 0) {
          let msg = (errorMsgs == null ? void 0 : errorMsgs.productMinErrMsg) ? errorMsgs.productMinErrMsg.replace("{productMin}", productMin).replace("{productName}", (_d = cartLineTarget == null ? void 0 : cartLineTarget.merchandise) == null ? void 0 : _d.title) : `You can't select less than ${productMin} for ${(_e = cartLineTarget == null ? void 0 : cartLineTarget.merchandise) == null ? void 0 : _e.title}.`;
          setErrorMessage(msg);
        } else if (quantity < productVariantMin && productVariantMin !== 0) {
          let msg = (errorMsgs == null ? void 0 : errorMsgs.variantMinErrMsg) ? errorMsgs.variantMinErrMsg.replace("{productVariantMin}", productVariantMin).replace("{productName}", (_f = cartLineTarget == null ? void 0 : cartLineTarget.merchandise) == null ? void 0 : _f.title) : `You can't select less than ${productVariantMin} for this product variant ${(_g = cartLineTarget == null ? void 0 : cartLineTarget.merchandise) == null ? void 0 : _g.title}.`;
          setErrorMessage(msg);
        } else if (quantity > productMax && productMax > 0) {
          let msg = errorMsgs.productMaxErrMsg ? errorMsgs.productMaxErrMsg.replace("{productMax}", productMax).replace("{productName}", (_h = cartLineTarget == null ? void 0 : cartLineTarget.merchandise) == null ? void 0 : _h.title) : `Quantity limit reached, you can't select more than ${productMax} for ${(_i = cartLineTarget == null ? void 0 : cartLineTarget.merchandise) == null ? void 0 : _i.title}.`;
          setErrorMessage(msg);
        } else if (quantity > productVariantMax && productVariantMax > 0) {
          let msg = errorMessagesFieldValue.variantMaxErrMsg ? errorMessagesFieldValue.variantMaxErrMsg.replace("{productVariantMax}", productVariantMax).replace("{productName}", (_j = cartLineTarget == null ? void 0 : cartLineTarget.merchandise) == null ? void 0 : _j.title) : `Quantity limit reached, you can't select more than ${productVariantMax}.`;
          setErrorMessage(msg);
        }
      }
    ...
    useBuyerJourneyIntercept(({ canBlockProgress: canBlockProgress2 }) => {
      if ((errorMsgs == null ? void 0 : errorMsgs.extensionMsg) === "Checkout Extension" || (errorMsgs == null ? void 0 : errorMsgs.extensionMsg) === "Both") {
        if (canBlockProgress2 && errorMessage) {
          return {
            behavior: "block",
            ...
            errors: [
              {
                ...
                message: `Please refer to the messages at the below of the products`
              }
            ]
          };
        }
    ...
    if (errorMessage && canBlockProgress && ((errorMsgs == null ? void 0 : errorMsgs.extensionMsg) === "Checkout Extension" || (errorMsgs == null ? void 0 : errorMsgs.extensionMsg) === "Both")) {
      return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Text2, { children: errorMessage });
    }
    return null;
  }
})();
