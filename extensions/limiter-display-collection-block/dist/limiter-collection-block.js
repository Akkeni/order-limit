(() => {
  ...
  function updateCollectionLimit(productId, limiters) {
    return __async(this, null, function* () {
      const collectionValue = (limiters == null ? void 0 : limiters.collectionName) + "," + (limiters == null ? void 0 : limiters.collectionMin) + "," + (limiters == null ? void 0 : limiters.collectionMax);
      ...
      for (const edge of allProductsData) {
        ...
        if ((_l = (_k = collectionData == null ? void 0 : collectionData.data) == null ? void 0 : _k.collection) == null ? void 0 : _l.hasProduct) {
          ...
          if ((_p = (_o = edge == null ? void 0 : edge.node) == null ? void 0 : _o.collectionLimitField) == null ? void 0 : _p.value) {
            const [collectionName, collectionMin, collectionMax] = (_r = (_q = edge == null ? void 0 : edge.node) == null ? void 0 : _q.collectionLimitField) == null ? void 0 : _r.value.split(",");
  ...
  function getExistingCollectionLimits() {
    return __async(this, null, function* () {
      const allProductsData = yield getAllProductsData();
  ...
  function App() {
      ...
      (function getCollectionInfo() {
        return __async(this, null, function* () {
          ...
          if (collectionData) {
            ...
            if (freePlanLimiters) {
              const existingCollectionLimit = yield getExistingCollectionLimits();
    ...
    return (
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(AdminBlock2, { title: "Order Limit app limiters", children: [
        ...
        !loading && !(limiters == null ? void 0 : limiters.plan) && !isAllow && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { as: "p", tone: "critical", children: "You used allowed collection wise limits. To continue please select a plan or set existing limits to 0." }),
